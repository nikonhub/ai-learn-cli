...
func (tx *Tx) init() {
	tx.GeneratedProblem = NewGeneratedProblemClient(tx.config)
	tx.Item = NewItemClient(tx.config)
	tx.ItemProgress = NewItemProgressClient(tx.config)
...
// applies a query, for example: GeneratedProblem.QueryXXX(), the query will be executed
