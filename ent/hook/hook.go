...
// The GeneratedProblemFunc type is an adapter to allow the use of ordinary
// function as GeneratedProblem mutator.
type GeneratedProblemFunc func(context.Context, *ent.GeneratedProblemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GeneratedProblemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GeneratedProblemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GeneratedProblemMutation", m)
}
...
// The ItemProgressFunc type is an adapter to allow the use of ordinary
// function as ItemProgress mutator.
type ItemProgressFunc func(context.Context, *ent.ItemProgressMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ItemProgressFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ItemProgressMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ItemProgressMutation", m)
}
